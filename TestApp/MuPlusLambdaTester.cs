...
namespace TestApp
{
    class MuPlusLambdaJudgeClass : IOneChromosomeJudge<DoubleRealNumberChromosome>
    {
    ...
    class MuPlusLambdaTester
    {
        ...
        {
            //Get the args
            MuPlusLambdaStrategy<DoubleRealNumberChromosome> ga =
                (MuPlusLambdaStrategy<DoubleRealNumberChromosome>)sender;
        ...
        public void Run()
        {
            Console.WriteLine("MuPlusLambda #1 (LocalAverage)");
            best = null;

            //Create the strategy
            MuPlusLambdaStrategy<DoubleRealNumberChromosome> ga1 =
                new MuPlusLambdaStrategy<DoubleRealNumberChromosome>(1000, 500);
            //Assign a generator
            ga1.ChromosomeGenerator =
                new DoubleRealNumberChromosomeGenerator(AckleyFunction.Dimentions, -30, 30, 60);
            //Assign a crossover
            ...
            //Print result
            Console.WriteLine("MuPlusLambda Best: {0}", best.Value);

            Console.WriteLine("MuPlusLambda #2 (LocalDiscrete)");
            best = null;

            //Create the strategy
            MuPlusLambdaStrategy<DoubleRealNumberChromosome> ga2 =
                new MuPlusLambdaStrategy<DoubleRealNumberChromosome>(1000, 500);
            //Assign a generator
            ...
            Console.WriteLine("MuPlusLambda #3 (GlobalAverage)");
            best = null;

            //Create the strategy
            MuPlusLambdaStrategy<DoubleRealNumberChromosome> ga3 =
                new MuPlusLambdaStrategy<DoubleRealNumberChromosome>(1000, 500);
            //Assign a generator
            ...
            Console.WriteLine("MuPlusLambda #4 (GlobalDiscrete)");
            best = null;

            //Create the strategy
            MuPlusLambdaStrategy<DoubleRealNumberChromosome> ga4 =
                new MuPlusLambdaStrategy<DoubleRealNumberChromosome>(1000, 500);
            //Assign a generator
